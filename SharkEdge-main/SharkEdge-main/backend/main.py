...
def fetch_sport_prop_board(
    ...
    top_props = build_top_prop_feed(enriched_props)
    return {
        "key": sport["key"],
        "title": sport["title"],
        "short_title": sport["short_title"],
...
def build_game_detail(
    ...
    *,
    ...
    return {
        ...
        "sharp_signals": game.get("sharp_signals") or build_sharp_signals(
            bookmakers,
            away_team,
            home_team,
        ),
...
def props_board(
    ...
    response = {
        ...
        "errors": errors,
        "sports": responses,
        "top_props": build_top_prop_feed(
            [prop for sport in responses for prop in sport.get("props", [])],
            limit=30,
        ),
    }
