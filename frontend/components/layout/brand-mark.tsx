  ...
  if (compact) {
    return (
      <Link href="/" className="group flex items-center gap-2.5">
        <div className="shrink-0 overflow-hidden rounded-xl border border-white/10 bg-[#09111d] transition group-hover:border-sky-400/30">
          <img
        ...
        <div className="min-w-0">
          <div className="font-display text-[1.1rem] font-semibold leading-none tracking-tight text-white">
            Shark<span className="text-sky-400">Edge</span>
          </div>
          <div className="mt-0.5 text-[0.58rem] uppercase tracking-[0.22em] text-slate-500">
            Sports Intelligence
          </div>
        </div>
      </Link>
