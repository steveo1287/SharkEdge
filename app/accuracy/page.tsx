    ...
    <main className="mx-auto grid max-w-7xl gap-5 px-4 py-6 sm:px-6 lg:px-8">
      <section className="rounded-[1.75rem] border border-cyan-300/15 bg-slate-950/80 p-6 shadow-[0_0_60px_rgba(14,165,233,0.10)]">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">
          This replaces the old blended accuracy dashboard. MLB and UFC/MMA now live in separate ledgers so records, ROI, and proof cannot hide inside one combined page.
        </p>
      </section>
      ...
      <section className="rounded-[1.5rem] border border-white/10 bg-slate-950/70 p-5">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-400">
          The old all-in-one accuracy page is intentionally gone from this route. Open MLB or UFC/MMA separately and judge each product on its own record.
        </p>
      </section>
    </main>
  );
