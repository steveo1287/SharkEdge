      ...
      <div className="relative mx-auto grid max-w-7xl gap-4 px-3 pb-24 pt-3 sm:px-5 md:pb-10">
        <header className="rounded-[1.15rem] border border-white/10 bg-[#06101b]/88 p-3 backdrop-blur-xl">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2"><NavButton href="/sim" label="SimHub" active /><NavButton href="/sim/mlb" label="MLB" /><NavButton href="/sim/ufc" label="UFC" /><NavButton href="/results" label="Results" /><NavButton href="/proof" label="Proof" /><NavButton href="/accuracy" label="Accuracy" /></div>
          </div>
        </header>
